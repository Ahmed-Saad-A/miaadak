...
export default function Sidebar({ isOpen, setIsOpen }: SidebarProps) {
    ...
    // ✅ useRef فوق أي early return — قاعدة React: الـ hooks لازم تتنادى بنفس الترتيب دايماً
    const hoverTimer = useRef<ReturnType<typeof setTimeout> | null>(null);

    // ── إخفاء السايدبار للزوار غير المسجلين ─────────────────────────────
    if (!user || !role || !roleRoutes[role]) return null;
    ...
    // ── فتح / إغلاق بالهوفر مع delay يمنع الوميض ────────────────────────
    ...
    return (
        <>
            {/* ── Navbar للشاشات الصغيرة ─────────────────────────────────────── */}
            <nav className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-orange-500 text-white
                            flex items-center justify-between px-4 shadow-lg z-40">
                <button
            ...
            <aside
                ...
                className={`
                    bg-orange-500 text-white transition-all duration-500 flex flex-col py-6 shadow-lg
            ...
            >
                ...
                <button
                    ...
                    className={`
                        ...
                        transition-all duration-300 left-0 -translate-x-1/2
                    `}

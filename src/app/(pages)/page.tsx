...
//   return (
//     <div className="relative overflow-hidden bg-[#FFFFFF] rounded-2xl w-full flex items-center justify-center">
//       <motion.div
...
//       <main className="relative w-full max-w-6xl mt-16 sm:mt-0 lg:mt-0 md:mt-0 mx-auto grid grid-cols-1 md:grid-cols-2 md:items-center py-12 md:py-0 md:direction-ltr">
...
//             <h1 className="text-3xl sm:text-4xl md:text-9xl font-extrabold text-blue-900 leading-tight mb-4">
...
export default function Home() {
  return (
    <main className="flex flex-col bg-[#f4f4f4]">
      <div className="mb-9">
        <HeroSection />
      </div>

...
import SubjectsPage from "@/components/system/SubjectsPage";
    ...
    return (
        <>
            ...
            >
                ...
                {/* Toast */}
                {toast && (
                    <div className={`fixed top-5 left-1/2 -translate-x-1/2 z-50 px-5 py-3 rounded-2xl shadow-xl -sm font-semibold flex items-center gap-2 ${toast.type === "ok"
                ...
                <div className="mb-7 flex items-center justify-between gap-4 flex-wrap">
                    ...
                    <button
                        onClick={openAdd}
                        disabled={mode === "add"}
                        className="flex items-center gap-2 px-4 py-2.5 bg-amber-500 hover:bg-amber-600 disabled:opacity-50 text-white text-sm font-bold rounded-xl shadow-md shadow-amber-200 transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-amber-300 active:translate-y-0"
                    >
                            ...
                            <div className="bg-white rounded-2xl p-5 border border-amber-100"
                                ...
                                <div className="flex gap-2">
                                    <button
                                        onClick={handleSave}
                                        disabled={saving}
                                        className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold transition-all disabled:opacity-60" >
